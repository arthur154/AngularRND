...
namespace MemberProcess
{
    public static class MemberProcess
    {
        [FunctionName("MemberProcess")]
        [return: ServiceBus("status", Connection = "ServiceBusConnection")]
        public static string RunTopic([ServiceBusTrigger("incoming",
                                     "process",
                                     AccessRights.Manage,
                                 ...
                                 TraceWriter log)
        {
            ...
            var message = JsonConvert.DeserializeObject<Member>(topicMessage);
            MemberProcessDA auditDA = new MemberProcessDA();
            ...
            Status s = new Status()
            {
                ...
                link = string.Format("/api/member/{0}", message.id)
            };
    ...
    public class MemberProcessDA
    {
        ...
        public async Task<ResourceResponse<Document>> UpsertDoc(Member message)
        {
    ...
    {
        public string id { get { return ContractId; } }
